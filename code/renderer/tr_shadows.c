...
void RB_ProjectionShadowDeform( void ) {
	...
	ground[0] = backEnd.or_.axis[0][2];
	ground[1] = backEnd.or_.axis[1][2];
	ground[2] = backEnd.or_.axis[2][2];

	groundDist = backEnd.or_.origin[2] - backEnd.currentEntity->e.shadowPlane;
